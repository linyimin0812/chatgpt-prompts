const CHAT_GPT_PROMPTS = [
    ...
    {
        label: `Act as a JavaScript Console`,
    ...
    {
        label: `Act as a English Pronunciation Helper`,
        value: `I want you to act as an English pronunciation assistant for Turkish speaking people. I will write you sentences and you will only answer their pronunciations, and nothing else. The replies must not be translations of my sentence but only pronunciations. Pronunciations should use Turkish Latin letters for phonetics. Do not write explanations on replies. My first sentence is "how the weather is in Istanbul?"`
    },
    {
        label: `Act as a Spoken English Teacher and Improver`,
    ...
    {
        label: `Act as a Plagiarism Checker`,
    ...
    {
        label: `Act as a Football Commentator`,
    ...
    {
        label: `Act as a Stand-up Comedian`,
    ...
    {
        label: `Act as a Motivational Coach`,
